...
SEED_URL = f"https://sinhala.adaderana.lk/news.php?nid={start}"
...
for i in range(start, end):
    current_url = f'https://sinhala.adaderana.lk/news.php?nid={i}'
    ...
    headline_tag = page_soup.find("h1",  {"class": "news-heading"})
    ts_tag       = page_soup.find("p",   {"class": "news-datestamp english-font"})
    ...
    if headline and news:
        ...
        out_dir     = os.path.join(".", "adaderana_sinhala", date_folder)
